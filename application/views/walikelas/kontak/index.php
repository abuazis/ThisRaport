            ...
            <center>
                <div class="lebarop profile mt-3">
                    ...
                    <div class="col-md-6 kontac">
                        ...
                        <a href="<?= site_url('walikelas/kontak/buat'); ?>" class="btn btn-primary text-light float-right edit"> Masukan Kontak <i class="fas fa-edit"></i></a>
                        <?php else : ?>
                        <a href="<?= site_url('walikelas/kontak/ubah/' . $self['id']); ?>" class="btn btn-primary text-light float-right edit"> Edit <i class="fas fa-edit"></i></a>
                        <?php endif; ?>
                    </div>
                </div>
                <form action="" method="post" class="mt-4 mx-auto form-inline">
