                    ...
                    <center>
                        ...
                        <form action="" method="post" class="w-75" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="ortu" class="form-control" id="ortu" value="<?= set_value('ortu') ?>">
                            </div>
                            <div class="form-group mb-2">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="lahir" class="form-control" id="lahir" value="<?= set_value('lahir') ?>">
                            </div>
                            <div class="form-group mb-2">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="sekolah" class="form-control" id="sekolah" value="<?= set_value('sekolah') ?>">
                            </div>
