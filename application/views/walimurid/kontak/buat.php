                    ...
                    <center>
                        ...
                        <form action="" method="post" class="w-75" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="wa" class="form-control" id="wa" value="<?= set_value('wa'); ?>">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="line" class="form-control" id="line" value="<?= set_value('line'); ?>">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="anak" class="form-control" id="anak" value="<?= set_value('anak'); ?>">
                            </div>
